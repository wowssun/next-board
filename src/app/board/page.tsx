		...
		<>
			...
			<div>
				...
				{posts && posts.length > 0 ? (
					...
					>
						{/* Header */}
						<div className="hidden sm:flex md:text-lg text-gray-700 uppercase  dark:bg-gray-700 dark:text-gray-400 text-center bg-[#d8dfed] text-[#071952]">
						...
						<div>
							{posts.map((post) => (
								<Link
									href={`board/view/${post.id}?page=${p}`}
									key={post.id}
